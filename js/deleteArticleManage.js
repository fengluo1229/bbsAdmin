$($.ajax({
    url:"http://192.168.2.164:8080/admin/deleteArticle",
    type:"get",
    dataType:"json",
...
$($.ajax({
    url:"http://192.168.2.164:8080/admin/deleteArticle/pageNum",
    type:"get",
    success:function(data){
...
function cancelDelete(articleId){
    $.ajax({
        url:"http://192.168.2.164:8080/admin/article/cancelDelete",
        type:"post",
        data:{
            articleId:articleId
        },
