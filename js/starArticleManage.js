$($.ajax({
    url:"http://192.168.2.164:8080/admin/starArticle",
    type:"get",
    dataType:"json",
...
$($.ajax({
    url:"http://192.168.2.164:8080/admin/starArticle/pageNum",
    type:"get",
    success:function(data){
...
function cancelStar(articleId){
    $.ajax({
        url:"http://192.168.2.164:8080/admin/article/cancelStar",
        type:"post",
        data:{
            articleId:articleId
        },
