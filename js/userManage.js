$($.ajax({
    url:"http://192.168.2.164:8080/admin/user",
    type:"get",
    dataType:"json",
...
$($.ajax({
url:"http://192.168.2.164:8080/admin/user/pageNum",
type:"get",
dataType:"json",
success:function(data){
...
$.ajax({
url:"http://192.168.2.164:8080/admin/user/cancel",
type:"post",
data:{
    userName:userName
},
...
function banUser(){
$.ajax({
url:"http://192.168.2.164:8080/admin/user/ban",
type:"post",
data:{
